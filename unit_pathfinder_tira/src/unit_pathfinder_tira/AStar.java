...
public class AStar {
	...
	public ArrayList<int[]> search(Graph g, int[] start, int[] end) {
		...
		// The actual search algorithm where nodes are evaluated based on the estimated distance to end
	 ...
	 * @param a Coordinates of starting point
	 * @param b Coordinates of ending point
	...
	private void logBenchmark() {
		System.out.println(String.format("A* shortest path found a path for %s. \n"
				+ "Nodes visited: %s \n"
